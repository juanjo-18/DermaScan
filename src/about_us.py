...
# PEGAMOS NUESTRO CODIGO DE PAGINA
    def run(self):
        ...
        st.markdown(f"<h2 style='text-align:center;'>¡Bienvenido a nuestra sección 'About Us'! Aquí puedes conocer más sobre los creadores detrás de DermaScan: Juanjo Medina y Jesús Cánovas.</h2>", unsafe_allow_html=True)
