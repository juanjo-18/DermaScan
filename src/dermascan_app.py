...
# PEGAMOS NUESTRO CODIGO DE PAGINA 
    def run(self):
        ...
        with col5:
            ...
            st.markdown(f"<p style='text-align:center; '>Entrenamos nuestros modelos con miles de imágenes de piel, tanto sana como afectada pos algún tipo de lesión. En total hemops entrenado 5 modelos clasificadores con casi 100.000 imágenes</p>", unsafe_allow_html=True)
