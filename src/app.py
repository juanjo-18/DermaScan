...
def pagina_categoria_3():
    ...
    with col4:
        ...
        st.image("imagenes/sun_1.jpg", use_column_width=True, height=1024)
    ...
    with col5:
        ...
        st.image("imagenes/water_1.jpg", use_column_width=True, height=1024)
    ...
    with col6:
        ...
        st.image("imagenes/food_1.jpg", use_column_width=True, height=1024)
    ...
    with col7:
        ...
        st.image("imagenes/sun_2.jpg", use_column_width=True, height=1024)
    ...
    with col8:
        ...
        st.image("imagenes/zderm_1.jpg", use_column_width=True, height=1024)
    ...
    with col9:
        ...
        st.image("imagenes/sport_1.jpg", use_column_width=True, height=1024)
