...
# Sección: DermaScan App
    ...
    st.markdown(f"<p style='text-align:center; font-size:50px'>DermaScan App representa la vanguardia en el cuidado de la piel, utilizando modelos de inteligencia artificial para analizar imágenes y detectar posibles lesiones cutáneas.</p>", unsafe_allow_html=True)
